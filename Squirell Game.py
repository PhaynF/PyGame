...
MOVERATE = 13         # how fast the player moves //HERE
BOUNCERATE = 9       # how fast the player bounces (large is slower)//HERE
BOUNCEHEIGHT = 30    # how high the player bounces
STARTSIZE = 50       # how big the player starts off
WINSIZE = 300
LOSESIZE = 25# how big the player needs to be to win
...
SQUIRRELMINSPEED = 4 # slowest squirrel speed
SQUIRRELMAXSPEED = 9 # fastest squirrel speed
DIRCHANGEFREQ = 5    # % chance of direction change per frame
LEFT = 'left'
RIGHT = 'right'
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size']**2:
                        ...
                        if playerObj['health'] == 0 or playerObj['size']< LOSESIZE:
